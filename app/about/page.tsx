      ...
      <div className="max-w-7xl w-full flex-col">
        ...
        <div className="w-full flex flex-col items-center mt-32 mb-10">
          ...
          <div className="text-center tracking-wider mb-4 text-md sm:text-xl md:text-3xl flex items-center font-semibold md:font-normal">
            My name is Drew Merrill and I&apos;m a software developer! I made
            this website to teach myself web development and to have a public
            way to document my life and the fun projects I do.
          </div>
        </div>
        <div className="w-full  flex flex-col lg:flex-row">
          <div className="flex-1  p-7">
            <img
              className="aspect-auto object-cover w-full max-h-[600px]"
              src="/Fountain.webp"
              alt="Fountain"
            />
          </div>
          <div className="flex-1  p-7 flex-col flex ">
            ...
            <p className="text-2xl md:text-3xl">
              ...
              ASU and got my Masters Degree in Computer Science (Big Data
              Systems).
            </p>
          </div>
        </div>
        <div className="w-full flex flex-col-reverse lg:flex-row">
          <div className="flex-1  p-7 flex-col">
            <p className="text-2xl md:text-3xl mb-5">
              When I&apos;m not working on coding projects, I can usually be
              found reading, playing a board game, volleyball, or piano,
              woodworking, rock climbing, making a spreadsheet, or doing the New
