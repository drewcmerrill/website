  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className=" w-[400px] max-w-full relative rounded-2xl  flex-shrink-0  px-8 py-6 md:w-[450px]"
            key={item.id}
          >
            <blockquote>
              <div
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <img
                  className="aspect-auto object-cover w-full md:shadow-xl border-2 md:border-[3px]  border-black border-dashed"
                  src={item.img}
                />
              </div>
            </blockquote>
